...
/*
 * 6.8-style segment loading flow:
 * 1) map p_filesz bytes from file.
 * 2) clear the fractional tail page (padzero).
 * 3) allocate the remaining bss range with vm_brk_flags.
 */
static unsigned long
